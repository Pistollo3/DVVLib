...
public struct VFGQuickActionsResultModel {
    ...
    var headlineFont = UIFont.vodafoneBold(17)
    /// a property to change the font of the headline text
    var titleFont = UIFont.vodafoneRegular(25)
    ...
    public init(
        ...
        primaryButtonFont: UIFont = .vodafoneRegular(19),
        secondaryButtonFont: UIFont = .vodafoneRegular(19)
    ) {
        self.type = type
