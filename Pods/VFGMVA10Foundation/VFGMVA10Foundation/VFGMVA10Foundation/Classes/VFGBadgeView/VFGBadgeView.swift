...
public class VFGBadgeView: UIView {
    ...
    lazy var badgeContentView: VFGBadgeContentView? = {
        let view = UINib(
    ...
    public func setup(with badgeID: String) {
    ...
    public func update(with badgeModel: BadgeModel, badgeID: String = "") {
        self.badgeModel = badgeModel
        badgeContentView?.configure(with: badgeModel)
