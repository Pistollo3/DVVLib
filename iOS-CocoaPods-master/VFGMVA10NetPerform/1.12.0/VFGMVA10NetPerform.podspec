# Generated:Sun Sep 19 07:43:31 PDT 2021
...
Pod::Spec.new do |s|
    ...
    s.source = { :git => "https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-Netperform.git", :tag => "1.12.0" }
    s.platform = :ios, '11.0'
    s.swift_version = '5.0'
    s.requires_arc = true
    ...
    s.dependency 'VFGMVA10Foundation', '1.25.0'
    s.dependency 'Folly'
    s.dependency 'glog'
