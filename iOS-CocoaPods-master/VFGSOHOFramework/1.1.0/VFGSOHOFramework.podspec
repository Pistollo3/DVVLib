# Generated:Tue Aug 31 10:10:12 PDT 2021
...
Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-SOHO-Framework.git", :tag => "1.1.0" }
  s.platform = :ios, '11.0'
  s.swift_version = '5.0'
  ...
  s.dependency 'VFGMVA10Billing', '1.15.0'
  s.dependency 'VFGMVA10Framework', '1.16.0'
  s.requires_arc  = true
end
