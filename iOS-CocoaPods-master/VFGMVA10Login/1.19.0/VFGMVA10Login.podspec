# Generated:Tue Jul 27 06:47:56 PDT 2021
...
Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-Login'
  ...
  s.source = { :git => "https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-Login.git", :tag => "1.19.0" }
  s.platform = :ios, '11.0'
  s.swift_version = '5.0'
  s.requires_arc = true
