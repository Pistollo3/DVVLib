# Generated:Thu Oct 21 03:00:39 PDT 2021
...
s.source = { :git => "https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-Framework.git", :tag => "1.17.1" }
s.platform = :ios, '11.0'
s.swift_version = '5.0'
s.requires_arc = true
...
s.dependency 'VFGMVA10Login', '1.21.0'
s.dependency 'VFGMVA10Onboarding', '1.22.0'
s.dependency 'VFGMVA10Purchase', '1.4.0'
