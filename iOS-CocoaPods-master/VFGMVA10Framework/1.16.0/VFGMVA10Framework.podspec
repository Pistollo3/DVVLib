# Generated:Tue Aug 31 08:30:31 PDT 2021
...
s.source = { :git => "https://github.vodafone.com/VFGroup-MyVodafone-OnePlatform/iOS-MVA10-Framework.git", :tag => "1.16.0" }
s.platform = :ios, '11.0'
s.swift_version = '5.0'
s.requires_arc = true
...
s.dependency 'VFGMVA10Login', '1.20.0'
s.dependency 'VFGMVA10Onboarding', '1.21.0'
s.dependency 'VFGMVA10Purchase', '1.3.0'
