Pod::Spec.new do |s|
  ...
  s.license = {"type"=>"Copyright © 2021 Vodafone Group Services GmbH. All Rights Reserved."}
  ...
  s.requires_arc = true
    s.source = { :git => "https://github.vodafone.com/VFCPS-NetPerform/NetPerform-iOS-SDK.git", :tag => '7.1.1' }

  s.ios.deployment_target    = '10.0'
  s.ios.vendored_framework   = 'Framework/NetPerformSDK.xcframework'
end
